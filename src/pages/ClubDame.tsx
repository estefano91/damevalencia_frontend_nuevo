          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent">
                {i18n.language === 'en' ? 'DAME Club' : 'Club DAME'}
              </h1>
              <p className="text-muted-foreground">
                {i18n.language === 'en' 
                  ? 'Exclusive benefits for DAME members'
                  : 'Beneficios exclusivos para miembros DAME'}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
            <div>
              <h2 className="text-2xl font-bold flex items-center gap-2">
                ...
                {i18n.language === 'en' ? 'Your Promotions' : 'Tus Promociones'}
              </h2>
              <p className="text-muted-foreground">
                {i18n.language === 'en' 
            ...
            {promotions.length > 0 && (
              <Badge variant="secondary" className="text-lg px-4 py-2 bg-orange-100 text-orange-700 dark:bg-orange-900 dark:text-orange-200">
        ...
        {promotions.length === 0 ? (
          ...
          <div className="space-y-4">
            {promotions.map((promotion) => {
              ...
              return (
                <Card key={promotion.id} className="overflow-hidden hover:shadow-lg transition-shadow border-orange-200 dark:border-orange-800">
