...
Tickets from €10.50. The exhibition runs until 13 April. Ideal for planning an afternoon of culture and experience in the city.`,
  ...
  {
    slug: "carnaval-ruzafa-2026",
    title: "Carnaval de Ruzafa 2026: fiesta en el barrio",
    title_en: "Ruzafa Carnival 2026: neighbourhood celebration",
    excerpt: "Del 8 al 15 de febrero el Carnaval de Ruzafa vuelve con pregón, pasacalles y mercado al aire libre. Entrada gratuita.",
    excerpt_en: "From 8 to 15 February Ruzafa Carnival returns with opening speech, parade and outdoor market. Free admission.",
    publishedAt: "2026-01-26T10:00:00.000Z",
    author: "DAME",
    tags: ["carnaval", "ruzafa", "febrero", "valencia"],
    content: `Uno de los carnavales con más personalidad de Valencia es el de Ruzafa. En 2026 se celebra del 8 al 15 de febrero con una programación que incluye pregón de apertura, pasacalles por el barrio y un mercado al aire libre donde mezclarse con el ambiente más creativo de la ciudad.

La entrada es gratuita y el barrio se llena de disfraces, música y buen rollo. Si buscas planes de febrero en Valencia con sabor local y sin gastar, el Carnaval de Ruzafa es una apuesta segura.`,
    sourceUrl: "https://valenciasecreta.com/planes-febrero-valencia/#carnaval",
    sourceLabel: "Valencia Secreta — Planes febrero Valencia (Carnaval)",
    content_en: `One of the most distinctive carnivals in Valencia is Ruzafa's. In 2026 it runs from 8 to 15 February with a programme including an opening speech, a neighbourhood parade and an outdoor market where you can soak up the city's most creative vibe.

Admission is free and the neighbourhood fills with costumes, music and good vibes. If you're looking for February plans in Valencia with a local flavour and no cost, Ruzafa Carnival is a safe bet.`,
  },
  {
